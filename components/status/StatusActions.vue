  ...
  <div flex justify-between items-center class="status-actions">
    <div flex-1>
      <StatusActionButton
        ...
        color="text-blue" hover="text-blue" glowrea-group-hover="bg-blue/10"
    ...
    <div flex-1>
      <StatusActionButton
        ...
        color="text-green" hover="text-green" glowrea-group-hover="bg-green/10"
    ...
    <div flex-1>
      <StatusActionButton
        ...
        :glowrea-group-hover="useStarFavoriteIcon ? 'bg-yellow/10' : 'bg-rose/10'"
    ...
    <div flex-none>
      <StatusActionButton
        ...
        :glowrea-group-hover="useStarFavoriteIcon ? 'bg-rose/10' : 'bg-yellow/10' "
